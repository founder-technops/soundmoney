namespace SoundMoney.Models
{
    public class HistoricalFinancial
    {
        ...
        /// <summary>
        /// Historical Operating Profit Margin Percentage (EBIT / Revenue * 100).
        /// Supports direct data binding or automatic dynamic calculation.
        /// </summary>
        public decimal HistoricalOpmPercent=> (HistoricalRevenueCr > 0m ? Math.Round((HistoricalOperatingProfitCr / HistoricalRevenueCr) * 100m, 2) : 0m);
