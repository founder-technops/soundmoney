namespace SoundMoney.Models
{
    public class Financial
    {
        ...
        public decimal TotalAssetsCr => FixedAssetsCr + CwipCr + InvestmentsCr + OtherAssetsCr;
        ...
        public decimal NonCurrentAssetsCr => FixedAssetsCr + CwipCr + InvestmentsCr;
        ...
        public decimal CurrentLiabilitiesCr => CurrentAssetsCr - WorkingCapitalCr;
        ...
        /// </summary>
        public decimal CashConversionRatio => NetProfitCr > 0
            ? Math.Round(CashFromOperationsCr / NetProfitCr, 2)
            : 0m;
